...
class Cancer():
    def __init__(self, al, bl, delta_t, max_step, sigma, penalty, real_cost=False):
        ...
        # self.fitness_15 = 0.15
        # self.fitness_17 = 0.175
        # self.sl_aux = 20819.5731647138452 #[uM]
    ...
    def step(self,state,action):
        ...
        if xho < self.fb:
            ...
            reward = -(self.sigma + qg/self.qg_max + 10.0*ql/self.ql_max)*self.delta_t
            if self.step_cntr == self.max_step-1 or xho > self.rb: done = True
            else: done = False
